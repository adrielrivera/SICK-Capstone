...
TEST_THRESHOLDS = dict(
    ...
    KITE_MAX_DISTANCE=342.932,  # Increased from 242.932 (added 100cm for more leniency - floor detection)
    KITE_CENTER_DISTANCE=380.0,  # Increased from 280.0 (added 100cm for more leniency - floor detection)
...
KITE_MAX_DISTANCE = 342.932  # cm at max angle (shadow distance on floor) - Increased from 242.932 (added 100cm for floor detection)
KITE_CENTER_DISTANCE = 380.0  # cm at 0 degrees (shadow distance on floor) - Increased from 280.0 (added 100cm for floor detection)
...
def calculate_kite_safe_distance(angle_deg):
    ...
    # At 0°: 380cm, At ±20.0715°: 342.932cm (increased significantly to prevent floor detection)
