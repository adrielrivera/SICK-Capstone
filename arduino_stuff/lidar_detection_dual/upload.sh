#!/bin/bash
# Arduino Upload Script for LiDAR Detection System (Dual Input)

ARDUINO_DIR="$(dirname "$0")"
SKETCH_NAME="lidar_detection_dual.ino"
FQBN="arduino:avr:uno" # Fully Qualified Board Name for Arduino Uno

echo "=========================================="
echo "LiDAR Detection Arduino Upload Script (Dual Input)"
echo "=========================================="
...
echo "=========================================="
echo "NOTE: Dual Input System"
echo "  - Input 1: Analog A0 (OR gate - TiM100/TiM150, 5V)"
echo "  - Input 2: Digital Pin 3 (TiM240 from Pi GPIO, 3.3V)"
