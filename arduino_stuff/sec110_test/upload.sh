#!/bin/bash
# Arduino Upload Script for SEC110 Trigger Test
...
echo "=========================================="
echo "SEC110 Trigger Test - Upload Script"
echo "=========================================="

# Find Arduino port (prioritize ttyUSB0 for PBT Arduino, or ttyUSB1 for LiDAR)
...
echo "Output: Pin 7 will toggle LOW→HIGH every 2 seconds"
echo "Connect Pin 7 to SEC110 trigger input"
echo "=========================================="
